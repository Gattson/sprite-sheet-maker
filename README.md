...
- Two project modes: a classic pixel editor (grid, palettes, crisp pixels) and
  ...
  blend modes) — plus editable vector strokes and print projects.
- Animation tools: frames, onion skinning, in-canvas playback, free transform
  of selections.
- Export: PNG sprite sheets, animated GIF / APNG, video, or a ZIP of frames.
  Projects save and load as JSON files.
